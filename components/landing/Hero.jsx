    ...
    <div className=''>
      <div className='main  -mt-20'>
        ...
        <div className="content pb-10">
          ...
          <div className='pb-5 '>
            <p className='text-md text-[#c0c0c0] lg:text-md text-center  drop-shadow-2xl px-5'>Your Transforming Your Unique Vision into Reality Through Our Expert Lens</p>
          </div>
        </div>
      </div>
    </div>
