...
const Label = () => {
  return (
    <>
      ...
      <div className="hidden md:block leading-tight md:leading-normal"><p className="font-medium">Were live on <span className="underline underline-offset-2 decoration-2 group-hover:decoration-4 duration-200">Product Hunt</span> now!</p><p className="text-sm opacity-90">Woud love your support 🫶</p></div></a></div>
    </>
  )
}
