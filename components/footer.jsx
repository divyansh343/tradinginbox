      ...
      <div data-theme="dark" className='' >
        <div className="grid xxs:grid-cols-[16px_repeat(4,_1fr)_16px] ml-5 pt-10 lg:pt-0 lg:ml-20 xs:grid-cols-[6.865%_repeat(4,_1fr)_6.865%] relative bg-charcoal flex-[0_0_auto] xs:px-[0px] xxs:px-[16px] 2xl:pt-[160px] xl:pt-[108px] md:pt-[72px] xxs:pt-[48px] 2xl:pb-[160px] md:pb-[72px] xs:pb-[48px] xxs:pb-[28px]   xxs:pt-[40px]  xl:pb-[60px] xxs:pb-[40px]">
          <div className="col-span-6 xxs:col-span-4 xxs:col-start-2">
            <div className="col-start-1 md:row-start-1 xxs:row-start-auto md:col-span-4 xs:col-span-2 xxs:col-span-1 grid lg:grid-cols-4 xs:grid-cols-2 xxs:grid-cols-1 auto-rows-min relative">
              <div className="flex flex-col justify-between pr-[10px] gap-[24px] md:col-span-1 xs:col-span-2">
                <div>
                  ...
                  <Image alt='brandcraft logo' className='' src={sheet} height={90} width={90} />
                ...
                <div className="footer-green">
                  <div>
                    ...
                    <p className="min-h-base break-words duration-200 prose max-w-full min-h-[1em] relative marker:text-charcoal text-left text-base font-CircularStd tracking-normal prose-white">

                      <span>
                        <span className="relative z-[1]">

                          <span><a href="mailto:hello@eachandother.com" className="prose group pb-0 hover:cursor-pointer duration-200 no-underline">
                            <span className="group-hover:prose-white  break-words duration-200 prose max-w-full min-h-[1em] relative marker:text-charcoal text-left text-base font-normal font-CircularStd tracking-normal prose-green">hello@eachandother.com</span></a></span></span></span></p><p className="min-h-base break-words duration-200 prose max-w-full min-h-[1em] relative marker:text-charcoal text-left text-base font-CircularStd tracking-normal prose-white">

                      <span>
                        <span className="relative z-[1]"></span></span>

                    </p><p className="min-h-base break-words duration-200 prose max-w-full min-h-[1em] relative marker:text-charcoal text-left text-base font-CircularStd tracking-normal prose-white">

                      <span>
                        <span className="relative z-[1]">Huckletree D2</span></span>

                    </p>
                    <p className="min-h-base break-words duration-200 prose max-w-full min-h-[1em] relative marker:text-charcoal text-left text-base font-CircularStd tracking-normal prose-white">

                      <span>
                        <span className="relative z-[1]">The Academy</span></span></p><p className="min-h-base break-words duration-200 prose max-w-full min-h-[1em] relative marker:text-charcoal text-left text-base font-CircularStd tracking-normal prose-white">

                      <span>
                        <span className="relative z-[1]">42 Pearse Street</span></span></p><p className="min-h-base break-words duration-200 prose max-w-full min-h-[1em] relative marker:text-charcoal text-left text-base font-CircularStd tracking-normal prose-white">
              ...
              <div className="mt-[48px] pr-[10px]"><h4 className="prose break-words max-w-title relative  xxs:text-lg font-bold prose-white font-CircularStd md:text-xl xxs:text-lg md:font-bold xxs:font-black">Services</h4><ul className="flex flex-col gap-4 md:mt-[28px] xxs:mt-[16px] md:gap-[28px] xxs:gap-[12px]"><li className="lg:-mb-4"><a className="prose group pb-0 hover:cursor-pointer duration-200 no-underline" href="/services/UX-research">
                ...
                <span>
                  <span className="group-hover:prose-green md:prose-white xxs:prose-dark_gray break-words duration-200 prose max-w-full min-h-[1em] relative marker:text-charcoal text-left text-base font-normal font-SometypeMono tracking-normal prose-white">Research</span></span></a></li><li className="lg:-mb-4"><a className="prose group pb-0 hover:cursor-pointer duration-200 no-underline" href="/services/ux-ui-and-product-design">
                    ...
                    <span>
                      <span className="group-hover:prose-green md:prose-white xxs:prose-dark_gray break-words duration-200 prose max-w-full min-h-[1em] relative marker:text-charcoal text-left text-base font-normal font-SometypeMono tracking-normal prose-white">UX &amp; UI Design</span></span></a></li><li className="lg:-mb-4"><a className="prose group pb-0 hover:cursor-pointer duration-200 no-underline" href="/services/capability-and-ux-teams">

                        <span>
                          <span className="group-hover:prose-green md:prose-white xxs:prose-dark_gray break-words duration-200 prose max-w-full min-h-[1em] relative marker:text-charcoal text-left text-base font-normal font-SometypeMono tracking-normal prose-white">Capability &amp; UX Teams</span></span></a></li></ul>

              </div>

              <div className="mt-[48px] pr-[10px]"><h4 className="prose break-words max-w-title relative xxs:text-lg font-bold prose-white font-CircularStd md:text-xl xxs:text-lg md:font-bold xxs:font-black">Studio</h4><ul className="flex flex-col gap-4 md:mt-[28px] xxs:mt-[16px] md:gap-[28px] xxs:gap-[12px]"><li className="lg:-mb-4"><a className="prose group pb-0 hover:cursor-pointer duration-200 no-underline" href="/studio/our-team">
                <span>
                  <span className="group-hover:prose-green md:prose-white xxs:prose-dark_gray break-words duration-200 prose max-w-full min-h-[1em] relative marker:text-charcoal text-left text-base font-normal font-SometypeMono tracking-normal prose-white">Our Team</span></span></a></li><li className="lg:-mb-4"><a className="prose group pb-0 hover:cursor-pointer duration-200 no-underline" href="/studio/our-approach">

                    <span>
                      <span className="group-hover:prose-green md:prose-white xxs:prose-dark_gray break-words duration-200 prose max-w-full min-h-[1em] relative marker:text-charcoal text-left text-base font-normal font-SometypeMono tracking-normal prose-white">Our Approach</span></span></a></li><li className="lg:-mb-4"><a className="prose group pb-0 hover:cursor-pointer duration-200 no-underline" href="/studio/our-partners">

                        <span>
                          <span className="group-hover:prose-green md:prose-white xxs:prose-dark_gray break-words duration-200 prose max-w-full min-h-[1em] relative marker:text-charcoal text-left text-base font-normal font-SometypeMono tracking-normal prose-white">Our Partners</span></span></a></li><li className="lg:-mb-4"><a className="prose group pb-0 hover:cursor-pointer duration-200 no-underline" href="/studio/education-and-community">

                            <span>
                              <span className="group-hover:prose-green md:prose-white xxs:prose-dark_gray break-words duration-200 prose max-w-full min-h-[1em] relative marker:text-charcoal text-left text-base font-normal font-SometypeMono tracking-normal prose-white">Education &amp; Community</span></span></a></li><li className="lg:-mb-4"><a className="prose group pb-0 hover:cursor-pointer duration-200 no-underline" href="/studio/careers">

                                <span>
                                  <span className="group-hover:prose-green md:prose-white xxs:prose-dark_gray break-words duration-200 prose max-w-full min-h-[1em] relative marker:text-charcoal text-left text-base font-normal font-SometypeMono tracking-normal prose-white">Careers</span></span></a></li></ul>

              </div>

              <div className="mt-[48px] pr-[10px]"><h4 className="prose break-words max-w-title relative md:text-xl xxs:text-lg font-bold prose-white font-CircularStd  xxs:text-lg md:font-bold xxs:font-black">News &amp; Views</h4><ul className="flex flex-col gap-4 md:mt-[28px] xxs:mt-[16px] md:gap-[28px] xxs:gap-[12px]"><li className="lg:-mb-4"><a className="prose group pb-0 hover:cursor-pointer duration-200 no-underline" href="/views">

                <span>
                  <span className="group-hover:prose-green md:prose-white xxs:prose-dark_gray break-words duration-200 prose max-w-full min-h-[1em] relative marker:text-charcoal text-left text-base font-normal font-SometypeMono tracking-normal prose-white">Views</span></span></a></li><li className="lg:-mb-4"><a className="prose group pb-0 hover:cursor-pointer duration-200 no-underline" href="/news">

                    <span>
                      <span className="group-hover:prose-green md:prose-white xxs:prose-dark_gray break-words duration-200 prose max-w-full min-h-[1em] relative marker:text-charcoal text-left text-base font-normal font-SometypeMono tracking-normal prose-white">Company news</span></span></a></li></ul>
            ...
            <div className="ms: mt-[0px] xxs:mt-[48px] md:mt-[36px] md:pt-0 xxs:pt-[32px] md:border-none xxs:border-dark_gray xxs:border-t col-start-1 md:row-start-1 xxs:row-start-auto md:col-span-4 xs:col-span-2 xxs:col-span-1 grid lg:grid-cols-4 xs:grid-cols-2 xxs:grid-cols-1 auto-rows-min relative">
              <div className="col-start-1 md:pt-[25px] xxs:pt-0 md:col-span-1 xxs:col-span-2 ">
                <div>

                  <p className="min-h-base break-words duration-200 prose max-w-full min-h-[1em] relative marker:text-charcoal text-left text-base font-CircularStd tracking-normal prose-white">

                    <span>
                      <span className="relative z-[1]">Copyright © 2023 Each&amp;Other Ltd. </span></span></p><p className="min-h-base break-words duration-200 prose max-w-full min-h-[1em] relative marker:text-charcoal text-left text-base font-CircularStd tracking-normal prose-white">

                    <span>
                      <span className="relative z-[1]">Registered in Ireland. No. 545982</span></span></p><p className="min-h-base break-words duration-200 prose max-w-full min-h-[1em] relative marker:text-charcoal text-left text-base font-CircularStd tracking-normal prose-white">

                    <span>
                      <span className="relative z-[1]"><a className="prose group pb-0 hover:cursor-pointer duration-200 no-underline" href="/privacy-policy">

                        <span>
                          <span className="group-hover:prose-white  break-words duration-200 prose max-w-full min-h-[1em] relative marker:text-charcoal text-left text-base font-normal font-CircularStd tracking-normal prose-pink">Privacy Policy</span></span></a></span></span></p>
