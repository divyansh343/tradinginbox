...
const Services = () => {
  return (
    <div id="service" className="  overflow-hidden">
      <div className="py-24 px-4 max-w-7xl mx-auto">
        ...
        <div className="container px-2 md:px-10">
          ...
          <div data-aos="fade-up" data-aos-duration="1000" className="aos-init aos-animate">
              <div className="group rounded-3xl cursor-pointer border-primary bg-base-100 p-6 shadow-[-20px_30px_70px_rgba(219,222,225,0.4)] transition duration-500 hover:border-secondary hover:bg-secondary/20 ">
                ...
                <a href="services-detail.html" className="my-8 inline-block text-lg font-extrabold text-primary  ">Website Development</a>
            ...
            <div data-aos="fade-up" data-aos-duration="1000" className="aos-init aos-animate">
              <div className="group rounded-3xl cursor-pointer border-primary bg-base-100 p-6 shadow-[-20px_30px_70px_rgba(219,222,225,0.4)] transition duration-500 hover:border-secondary hover:bg-secondary/20 dark:border-primary/10 dark:bg-transparent dark:bg-gradient-to-b dark:from-white/[0.04] dark:to-transparent dark:!shadow-none dark:hover:bg-secondary">
                ...
                <a href="services-detail.html" className="my-8 inline-block text-lg font-extrabold text-primary  ">SEO</a>
                <p className="mb-10 text-md  transition line-clamp-3 ">
            ...
            <div data-aos="fade-up" data-aos-duration="1000" className="aos-init aos-animate">
              <div className="group rounded-3xl cursor-pointer border-primary bg-base-100 p-6 shadow-[-20px_30px_70px_rgba(219,222,225,0.4)] transition duration-500 hover:border-secondary hover:bg-secondary/20 dark:border-primary/10 dark:bg-transparent dark:bg-gradient-to-b dark:from-white/[0.04] dark:to-transparent dark:!shadow-none dark:hover:bg-secondary">
                ...
                <a href="services-detail.html" className="my-8 inline-block text-lg font-extrabold text-primary ">Online Marketing</a>
                <p className="mb-10 text-md  transition line-clamp-3 ">
