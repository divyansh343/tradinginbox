        ...
        <div className="flex flex-col text-center w-full my-10">
          ...
          <div className="mb-8">
            <h2 className="sm:text-4xl text-3xl font-bold text-base-content">
              Our Services for your businesses
            </h2>
          </div>
          ...
          <div className="grid gap-6  md:grid-cols-2">
            ...
            <Link href="/web_development">
              <div data-aos="fade-up" data-aos-duration="1000" className="aos-init aos-animate">
                <div className="group rounded-3xl cursor-pointer border-primary bg-base-100 p-6 shadow-[-20px_30px_70px_rgba(219,222,225,0.4)] transition duration-500  hover:bg-primary/20 ">
                  ...
                  <a href="services-detail.html" className="mt-8 mb-6 inline-block text-lg font-extrabold   ">Website Development & Managemet</a>
            ...
            <Link href="/branding_101">
              <div data-aos="fade-up" data-aos-duration="1000" className="aos-init aos-animate">
                <div className="group  rounded-3xl cursor-pointer border-primary p-6 shadow-[-20px_30px_70px_rgba(219,222,225,0.4)] transition duration-500  hover:bg-primary/20 ">
                  ...
                  <a href="services-detail.html" className="mt-8 mb-6 inline-block text-lg font-extrabold   ">Brand Magnet 360*  </a>
            ...
            <Link href="/seo">
              <div data-aos="fade-up" data-aos-duration="1000" className="aos-init aos-animate">
                <div className="group rounded-3xl cursor-pointer border-primary bg-base-100 p-6 shadow-[-20px_30px_70px_rgba(219,222,225,0.4)] transition duration-500  hover:bg-primary/20 dark:border-primary/10 dark:bg-transparent dark:bg-gradient-to-b dark:from-white/[0.04] dark:to-transparent dark:!shadow-none dark:hover:bg-secondary">
                  ...
                  <a href="services-detail.html" className="mt-8 mb-6 inline-block text-lg font-extrabold   ">SEO</a>
                  <p className="mb-10 text-lg  transition line-clamp-3 ">
            ...
            <Link href="/digital_marketing">
              <div data-aos="fade-up" data-aos-duration="1000" className="aos-init aos-animate">
                <div className="group rounded-3xl cursor-pointer border-primary bg-base-100 p-6 shadow-[-20px_30px_70px_rgba(219,222,225,0.4)] transition duration-500  hover:bg-primary/20 dark:border-primary/10 dark:bg-transparent dark:bg-gradient-to-b dark:from-white/[0.04] dark:to-transparent dark:!shadow-none dark:hover:bg-secondary">
                  ...
                  <a href="services-detail.html" className="mt-8 mb-6 inline-block text-lg font-extrabold  ">Digital Marketing</a>
                  <p className="mb-10 text-lg  transition line-clamp-3 ">
