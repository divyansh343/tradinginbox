    ...
    <div className="  overflow-hidden">
      <div className="py-24 px-4 max-w-7xl mx-auto">
        <div className="flex flex-col text-center w-full mb-20">
          ...
          <div className="mb-8">
            <h2 className="sm:text-4xl text-3xl font-bold text-base-content">A landing page for 10x less than a designer price
            </h2>
          </div>
          <div className="lg:w-2/3 mx-auto leading-relaxed text-base text-base-content-secondary">Build a professional landing page in seconds.
        ...
        <div className="container px-2 lg:px-10">
          ...
          <div data-aos="fade-up" data-aos-duration="1000" className="aos-init aos-animate">
              <div className="group rounded-3xl border-2 border-primary bg-base-200 p-6 shadow-[-20px_30px_70px_rgba(219,222,225,0.4)] transition duration-500 hover:border-secondary hover:bg-secondary/20 ">
                ...
                <a href="services-detail.html" className="my-8 inline-block text-[22px] font-extrabold text-primary  ">Web Development</a>
            ...
            <div data-aos="fade-up" data-aos-duration="1000" className="aos-init aos-animate">
              <div className="group rounded-3xl border-2 border-primary bg-base-200 p-6 shadow-[-20px_30px_70px_rgba(219,222,225,0.4)] transition duration-500 hover:border-secondary hover:bg-secondary/20 dark:border-primary/10 dark:bg-transparent dark:bg-gradient-to-b dark:from-white/[0.04] dark:to-transparent dark:!shadow-none dark:hover:bg-secondary">
                ...
                <a href="services-detail.html" className="my-8 inline-block text-[22px] font-extrabold text-primary  ">UI/UX Design</a>
                <p className="mb-10 text-lg font-semibold transition line-clamp-3 ">
            ...
            <div data-aos="fade-up" data-aos-duration="1000" className="aos-init aos-animate">
              <div className="group rounded-3xl border-2 border-primary bg-base-200 p-6 shadow-[-20px_30px_70px_rgba(219,222,225,0.4)] transition duration-500 hover:border-secondary hover:bg-secondary/20 dark:border-primary/10 dark:bg-transparent dark:bg-gradient-to-b dark:from-white/[0.04] dark:to-transparent dark:!shadow-none dark:hover:bg-secondary">
                ...
                <a href="services-detail.html" className="my-8 inline-block text-[22px] font-extrabold text-primary  ">Digital Marketing</a>
                <p className="mb-10 text-lg font-semibold transition line-clamp-3 ">
