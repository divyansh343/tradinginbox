        ...
        <div className="container md:px-3 lg:px-10">
          ...
          <div className="grid gap-4  md:grid-cols-3">
            ...
            <Link href="/brand_magnet">
              <div data-aos="fade-up" data-aos-duration="1000" className="aos-init aos-animate">
                <div className="group  rounded-3xl cursor-pointer border-primary bg-primary/10 drop-shadow p-6 shadow-[-20px_30px_70px_rgba(219,222,225,0.4)] transition duration-500  hover:bg-primary/20 ">
