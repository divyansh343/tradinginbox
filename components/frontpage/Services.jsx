    ...
    <div className="  overflow-hidden">
      <div className="py-24 px-4 max-w-7xl mx-auto">
        <div className="flex flex-col text-center w-full my-10">
          ...
          <div className="mb-8">
            <h2 className="sm:text-4xl text-3xl font-bold text-base-content">Crafting the perfect influencer campaign 
            </h2>
          </div>
          {/* <div className="lg:w-2/3 mx-auto leading-relaxed text-base text-base-content-secondary">begins with strategic selection.
        ...
        <div className="container px-2 lg:px-10">
          ...
          <div data-aos="fade-up" data-aos-duration="1000" className="aos-init aos-animate">
              <div className="group rounded-3xl border-2 border-primary bg-base-200 p-6 shadow-[-20px_30px_70px_rgba(219,222,225,0.4)] transition duration-500 hover:border-secondary hover:bg-secondary/20 ">
                ...
                <a href="services-detail.html" className="my-8 inline-block text-[22px] font-extrabold text-primary  ">Influencer Marketing</a>
                <p className="mb-10 text-lg  transition line-clamp-3 ">
                Building influencer relationships. We handle communication and campaign management.
                </p>
            ...
            <div data-aos="fade-up" data-aos-duration="1000" className="aos-init aos-animate">
              <div className="group rounded-3xl border-2 border-primary bg-base-200 p-6 shadow-[-20px_30px_70px_rgba(219,222,225,0.4)] transition duration-500 hover:border-secondary hover:bg-secondary/20 dark:border-primary/10 dark:bg-transparent dark:bg-gradient-to-b dark:from-white/[0.04] dark:to-transparent dark:!shadow-none dark:hover:bg-secondary">
                <div className="flex h-14 w-14 items-center justify-center rounded-full bg-secondary shadow-[0px_15px_30px_rgba(180,118,229,0.4)] transition group-hover:bg-black">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <a href="services-detail.html" className="my-8 inline-block text-[22px] font-extrabold text-primary  ">Niche Marketing</a>
                <p className="mb-10 text-lg  transition line-clamp-3 ">
            ...
            <div data-aos="fade-up" data-aos-duration="1000" className="aos-init aos-animate">
              <div className="group rounded-3xl border-2 border-primary bg-base-200 p-6 shadow-[-20px_30px_70px_rgba(219,222,225,0.4)] transition duration-500 hover:border-secondary hover:bg-secondary/20 dark:border-primary/10 dark:bg-transparent dark:bg-gradient-to-b dark:from-white/[0.04] dark:to-transparent dark:!shadow-none dark:hover:bg-secondary">
                ...
                <a href="services-detail.html" className="my-8 inline-block text-[22px] font-extrabold text-primary  ">Youtube Marketing</a>
                <p className="mb-10 text-lg  transition line-clamp-3 ">
