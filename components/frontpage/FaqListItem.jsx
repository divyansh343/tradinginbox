    ...
    <>
      <li>
        <button onClick={toggle === 0 ? () => settoggle(1) : () => settoggle(0)}
          className="relative flex gap-2 items-center w-full py-5 text-base text-left border-t md:text-lg border-base-content/10" aria-expanded="false"><span className="flex-1 text-base-content ">{que}</span>
          ...
          toggle === 0 ?
            <>
              <div className="transition-all duration-300 ease-in-out opacity-80 overflow-hidden" >
                <div className="pb-5 leading-relaxed text-secondary">{ans}
                </div>
              </div>
            </> : null
        }
