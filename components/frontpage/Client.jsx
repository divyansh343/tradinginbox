      ...
      <div className='grid justify-center px-3 gap-3 mt-20 mb-5'>
        ...
        <div className='grid justify-center'>
          <a href='https://arpitsite.netlify.app/' target='_blank' rel='noreferrer'>
            ...
            />
              <p className="mx-auto font-bold text-center text-lg text-gradient-cold mt-2">Arpit&apos;s portfolio-<span className=' ml-2 border-primary font-normal'>Filmakers & Photographer </span></p> 
          </a>
      ...
      <div className='grid justify-center px-3 gap-4 lg:mt-10 md:grid-cols-2'>
        ...
        <div className='grid justify-center'>
          <a href='https://kcrypto.info/' target='_blank' rel='noreferrer'>
            ...
            />
                <p className="mx-auto font-bold text-center text-lg text-gradient-cold mt-2">KCrypto -<span className=' ml-2 border-primary font-normal'>Crypto traders page</span></p> 
          </a>
        </div>
      </div>
