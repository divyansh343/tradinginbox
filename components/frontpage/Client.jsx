      ...
      <div className='grid justify-center px-3 gap-3 mt-20 mb-5'>
        ...
        <div className='grid justify-center'>
          <a href='https://arpitsite.netlify.app/' target='_blank' rel='noreferrer'>
            <HoverVideoPlayer
              className=" aspect-auto w-full sm:w-[45rem] border-2  border-base-content/20" width="1000" height="700"
            ...
            />
            <p className="mx-auto font-bold text-center text-lg text-gradient-cold mt-2">Arpit&apos;s portfolio-<span className=' ml-2 border-primary font-normal'>Filmaker & Photographer </span></p>
          </a>
