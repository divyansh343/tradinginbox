...
const Products = () => {
    ...
    const getAllProducts = async () => {
        ...
        let reqOptions = {
            url: "https://assessment.api.vweb.app/products",
            method: "GET",
            headers: headersList,
        }
                            ...
                            <div key={item.product_id} className="w-full max-w-sm mx-4 my-4 bg-white rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
                                <a href="#">
                                    <Image
                                        height={720}
                                        width={1200}
                                        className="p-8 rounded-t-lg" src="https://source.unsplash.com/random/900×700/?product" alt={item.name} />
                                </a>
                                <div className="px-5 pb-5">
                                    ...
                                    <div className="flex items-center mt-2.5 mb-5">
                                        ...
                                        <span className="bg-blue-100 text-blue-800 text-xs font-semibold mr-2 px-2.5 py-0.5 rounded dark:bg-blue-200 dark:text-blue-800 ml-3">{item.stock} stocks left</span>
                                    </div>
                                    <div className="flex justify-between items-center">
                                        <span className="text-xl  text-gray-900 dark:text-white">Price - <span className='font-bold'>{item.selling_price}</span> INR</span>
